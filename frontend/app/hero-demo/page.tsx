...
import { Sparkles, Rocket, Zap, Shield } from "lucide-react";
...
const HeroDemo: React.FC = () => {
        ...
        <div className="w-full">
            <Hero
                trustBadge={{
                    ...
                    icons: [<Rocket key="1" className="w-4 h-4" />, <Sparkles key="2" className="w-4 h-4" />, <Zap key="3" className="w-4 h-4" />]
                }}
                headline={{
                    line1: "Launch Your",
  ...
  trustBadge={{
    ...
    icons: [<Rocket />, <Sparkles />] // using lucide-react icons
  }}
  headline={{
